...
public class LinkedList<T> implements Iterable<T>, ILinkedList<T>, Cloneable{
    ...
    @Override
    public LinkedList<T> map(Consumer<T> function) {

        LinkedList<T> copyList = this.clone();
    ...
    @Override
    public <TResult> LinkedList<TResult> select(Function<T, TResult> predicate) {

        LinkedList<TResult> list = new LinkedList<>();
        for (T element : this){
            list.add(predicate.apply(element));
        }
        return list;
    }
